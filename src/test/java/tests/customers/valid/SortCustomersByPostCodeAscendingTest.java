...
public class SortCustomersByPostCodeAscendingTest extends Hooks {

    @Test(groups = {TestSuite.REGRESSION_SUITE, "customers", "validSortCustomers"})
    public void sortByPostCodeAscending() {
        ...
        bankManagerActions.sortByPostCode(true);
        Assert.assertTrue(bankManagerActions.validateSortedByPostCode(true));
