...
public class SortCustomersByLastNameAscendingTest extends Hooks {
    ...
    public void sortByLastNameAscending() {
        ...
        bankManagerActions.sortByLastName(true);
        Assert.assertTrue(bankManagerActions.validateSortedByLastName(true));
