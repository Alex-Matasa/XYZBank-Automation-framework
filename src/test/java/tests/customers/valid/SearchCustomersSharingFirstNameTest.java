...
public class SearchCustomersSharingFirstNameTest extends Hooks {
    ...
    public void searchByFirstNameMultipleMatches() {
        ...
        bankManagerActions.searchForACustomer(customer1.getFirstName());
        Assert.assertTrue(bankManagerActions.validateFilteredTableMultipleMatches(customer1.getFirstName(), 2));
