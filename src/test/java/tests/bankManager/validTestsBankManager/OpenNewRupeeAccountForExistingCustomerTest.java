...
public class OpenNewRupeeAccountForExistingCustomerTest extends Hooks {

    @Test(groups = {TestSuite.REGRESSION_SUITE, "openAccount", "validOpenAccount"})
    public void openRupeeAccountForAnnExistingCustomer() {
        DataModel dataModel = new DataModel(ResourcePath.NEW_RUPEE_ACCOUNT_FOR_AN_EXISTING_CUSTOMER_DATA);
