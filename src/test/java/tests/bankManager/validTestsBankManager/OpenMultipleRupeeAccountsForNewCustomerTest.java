...
public class OpenMultipleRupeeAccountsForNewCustomerTest extends Hooks {

    @Test(groups = {TestSuite.REGRESSION_SUITE, "openAccount", "validOpenAccount"})
    public void multipleRupeeAccountsForNewCustomer() {
        DataModel dataModel = new DataModel(ResourcePath.MULTIPLE_RUPEE_ACCOUNTS_FOR_NEW_CUSTOMER_DATA);
