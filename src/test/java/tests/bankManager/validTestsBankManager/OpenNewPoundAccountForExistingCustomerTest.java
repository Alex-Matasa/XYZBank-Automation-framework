...
public class OpenNewPoundAccountForExistingCustomerTest extends Hooks {

    @Test(groups = {TestSuite.REGRESSION_SUITE, "openAccount", "validOpenAccount"})
    public void openPoundAccountForAnnExistingCustomer() {
        DataModel dataModel = new DataModel(ResourcePath.NEW_POUND_ACCOUNT_FOR_AN_EXISTING_CUSTOMER_DATA);
